...
function startLoading() {
    ...
    var sigInIcon = $('#signIn');
    sigInIcon.addClass('uk-hidden');
    var busyIcon = $('#busySpinner');
    busyIcon.removeClass('uk-hidden');
...
function stopLoading() {
    var btn = $('form').find('button[type=submit]');
    var sigInIcon = $('#signIn');
    sigInIcon.removeClass('uk-hidden');
    var busyIcon = $('#busySpinner');
    busyIcon.addClass('uk-hidden');
